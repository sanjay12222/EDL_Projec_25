...
![Docs Added](https://github.com/edl-iitb/edl-25-project-submission-edl25_mon18/actions/workflows/classroom.yml/badge.svg)
...
## **Solution**
We developed a handheld corrosion detection device named **_CorroSense_**, designed specifically to detect pitting corrosion under insulation on metallic pipelines. The device leverages non-contact inductive sensing to detect subtle material loss beneath insulation layers without requiring any dismantling or physical intrusion.
